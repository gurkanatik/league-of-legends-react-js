...
export default function ({champions, filteredChampions, setFilteredChampions}) {
    const [value, setValue] = useState('')

    useEffect(() => {
        //filteredChampions = champions.filter((filteredChampion) => filteredChampion.name.toLowerCase().includes(value.toLowerCase()))
